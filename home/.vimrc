...
" Install plugins
" Plug 'arcticicestudio/nord-vim' " Colorscheme delek
...
let g:investigate_url_for_javascript="https://devdocs.io/^s"

let g:investigate_use_url="https://devdocs.io/^s"
" " -> EnhancedDiff
...
" vimwiki
let wiki_1 = {}
let wiki_1.path = '~/Dropbox/DRAFTS/vimwiki/'
